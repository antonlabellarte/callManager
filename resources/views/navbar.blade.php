...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body" style="display: flex; flex-direction: column;">
        <a href="/" class="defaultBtn" style="text-decoration: none; border: 1px solid lightgray; padding: 10px;">
            Vai al menù principale
        </a><br>
        <a class="defaultBtn" href="{{ route('logout') }}" style="text-decoration: none; border: 1px solid lightgray; padding: 10px;">
