<nav class="navbar" style="border: 1px solid transparent; background-color: #5F57A1; color: white;">
    <div class="container-fluid">
        <span style="float: left; font-weight: bold;">
        <!-- Icona navbar -->
        <a href="/" style="border: none; color: white; text-decoration: none;">
    ...
    @if (Auth::user())
        <span style="float: right;">
            ...
            <button style="width: fit-content;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                Menù
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body" style="display: flex; flex-direction: column;">
        <a href="/" class="defaultBtn" style="text-decoration: none; border: 1px solid transparent; padding: 10px;">
            Vai al menù principale
        </a><br>
        <a class="defaultBtn" href="{{ route('logout') }}" style="text-decoration: none; border: 1px solid transparent; padding: 10px;">
