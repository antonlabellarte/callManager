    ...
    <div class="row">
        <div class="col">
            ...
            <div style="margin-top: 20px;">
                <form method="GET" action="{{ route('rules.filter') }}" >
                    @csrf
                    @method('GET')
                    ...
                    <a href="{{ route('rules.index') }}">Reimposta filtri</a>
                </form>
            </div><br>
                ...
                <table>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>{{ $rule->servizioPartizionato}}</td>
                                <td>
                                    @if ($rule->dataInizio == "")
                                ...
                                <td>{{ \Carbon\Carbon::parse($rule->oraInizio)->format('H:i') }}</td>
                                <td>{{ \Carbon\Carbon::parse($rule->oraFine)->format('H:i') }}</td>
                                <td>
                                    @if ($rule->servizioUno == "")
                                        <span style="color: lightgray;">N\D</span>
                                    @else
                                ...
                                <td>
                                    <a href="{{ route('rules.edit', $rule->id)}}" class="tableBtn">
