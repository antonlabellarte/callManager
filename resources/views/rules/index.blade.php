                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>{{ $rule->dataFine}}</td>
                            <td>{{ $rule->dataFlag}}</td>
                            <td>{{ $rule->oraInizio}}</td>
                            <td>{{ $rule->oraFine}}</td>
                            <td>{{ $rule->servizioUno}}</td>
                            <td>{{ $rule->partizioneUno}}</td>
                            <td>{{ $rule->servizioDue}}</td>
                            <td>{{ $rule->partizioneDue}}</td>
                            <td>{{ $rule->servizioTre}}</td>
                            <td>{{ $rule->partizioneTre}}</td>
                            <td>
