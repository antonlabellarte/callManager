...
{{-- <div class="container">
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Go somewhere</a>
                ...
                {{-- <div style="border: 1px solid black; border-radius: 10px; border-color: darkgray; margin-top: 10px;">
...
<div class="container">
    <div class="row">
        ...
        <div style="margin-top: 10px;">
            Ordina per:<br>
            <button class="filterBtn">Nome servizio</button>
            <button class="filterBtn">Coda</button>
            <button class="filterBtn">Tipologia</button>
            <button class="filterBtn">Specializzazione</button>
        </div>
        <div class="col" style="margin-top: 10px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title">{{ $queue->coda}}</h5>
                <p class="card-text">{{ $queue->specializzazione}}</p>
                <p class="card-text">{{ $queue->tipologia}}</p>
                </div>
            </div><br>
            @endforeach
        </div>
...
<style>
    ...
    {{-- @if (count($queues) > 0)
        ...
        {{-- <div>
            <a href="{{ route('queues.edit', $queue->servizio) }}" class="tableBtn" style="background-color: transparent;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16"><path d="M15.502 1.94a.5.5 0 0 1 0 .506L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/><path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/></svg>
            </a>
