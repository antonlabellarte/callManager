...
<div class="container">
    <div class="row">
        <div class="col">
            <form action="{{ route('queues.update', $queue->servizio) }}" method="POST">
                @csrf
                @method('PUT')
                <p>Servizio</p>
                <input type="text" name="service" id="service" value="{{ $queue->servizio }}">
                <p>Coda</p>
                <input type="number" name="queue" id="queue" value="{{ $queue->coda }}">
                <p>Tipologia</p>
                <input type="text" name="type" id="type" value="{{ $queue->tipologia }}">
                <p>Specializzazione</p>
                <input type="text" name="skillGroup" id="skillGroup" oninput="emptySkillGroupText()" value="{{ $queue->specializzazione }}">
