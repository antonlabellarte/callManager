...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            @else
            <h3>Benvenuto, accedi per iniziare</h3>            
            @endif
            <form form method="GET" action="{{ route('login') }}">
                @csrf
                @method('GET')
                <label>
                ...
                <a href="#" style="color: blue;">Password dimenticata</a>
                <button class="loginBtn" type="submit" style="height: 35px;">
