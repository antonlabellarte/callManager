        ...
        <div class="col" action="">
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="abbattimento" id="abbattimento2" value="0" onchange="checkEmptiness()" {{ $campaigns->dropCall == 2 ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="enabled" id="enabled2" value="0" onchange="checkEmptiness()" {{ $campaigns->enabled == 2 ? 'checked' : '' }}>
                ...
                <div class="mb-3" id="startDateGroup">
                    ...
                    <input type="time" name="startTime" id="startTime"  value="{{ \Carbon\Carbon::parse($campaigns->dateStart)->format('H:i') }}">
                </div>
                ...
                <div class="mb-3" id="endDateGroup">
                    ...
                    <input type="time" name="endTime" id="endTime" value="{{ \Carbon\Carbon::parse($campaigns->dateEnd)->format('H:i') }}">
                </div>
