...
<div class="container" style="margin-top: 20px;">
    <div class="row">
        <div class="col">
            <h4 style="color: white; -webkit-text-stroke: 1px black;">Benvenuto</h4><br>
            <a class="defaultBtn" href="{{ route('rules.index') }}" style="padding: 10px; width: 300px; border-color: lightgray;">
            ...
            <a class="defaultBtn" href="{{ route('queues.index')}}" style="padding: 10px; width: 300px; border-color: lightgray;">
                <span style="float: left;">
            ...
            <a class="defaultBtn" href="{{ route('campaignsrules.index') }}" style="padding: 10px; width: 300px; border-color: lightgray;">
                <span style="float: left;">
