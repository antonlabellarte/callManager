...
<div class="container" style="margin-top: 20px;">
    <div class="row">
        <div class="col">
            ...
            <a class="defaultBtn" href="{{ route('services.index')}}" style="padding: 10px; width: 300px; border-color: lightgray;">
                <span style="float: left;">
            ...
            <a class="defaultBtn" href="{{ route('campaigns.index') }}" style="padding: 10px; width: 300px; border-color: lightgray;">
                <span style="float: left;">
